...
public class Card {
    public static Card[] initial_deck = {
        ...
        new WeaponCard(25, "Fencing Sword", "Waving it around makes you feel like D'Artagnan. Is that how you spell his name?"),
        new WeaponCard(26, "Coffee Pot", "A hazel liquid bubbles within, as if it may suddenly come to life"),
        new WeaponCard(27, "Pizza Roller", "It's circular blade sends shivers into the spines of all pizzas and small children"),
        new WeaponCard(28, "Candle", "A small flame could spread wildly across the whole facility. Or it just killed one person"),
